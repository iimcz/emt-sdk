...
namespace emt_sdk.Packages
{
    ...
    public partial class PackageDescriptor
    {
        public static PackageDescriptor FromJson(string json) => JsonConvert.DeserializeObject<PackageDescriptor>(json, emt_sdk.Packages.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this PackageDescriptor self) => JsonConvert.SerializeObject(self, emt_sdk.Packages.Converter.Settings);
    }
